...
const Expertise: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Header */}
      <section className="relative pt-40 pb-32 px-6 overflow-hidden bg-brand-dark">
        ...
        <div className="max-w-[1200px] mx-auto relative z-10 text-center space-y-8">
          ...
          <h1 className="text-5xl lg:text-8xl font-black font-display tracking-tighter text-white leading-[0.9]">
      ...
      <div className="max-w-[1440px] mx-auto px-6 lg:px-12 py-32">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center mb-32">
          <div className="space-y-10">
            <h2 className="text-4xl lg:text-6xl font-black font-display tracking-tight text-gray-900 leading-[0.95]">
          ...
          <div className="relative">
            ...
            <div className="absolute top-10 -right-10 bg-white p-10 rounded-[40px] shadow-2xl border border-gray-100 flex flex-col gap-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {[
            ...
            <div key={i} className="p-12 rounded-[40px] bg-gray-50 border border-gray-100 space-y-6 hover:bg-primary hover:text-white transition-all group">
